...
in {
  options.vim = {
    background = mkOption {
      default = "dark";
      description = "Adjust background colors for a dark/light theme. Can be dark, light";
    ...
    textWidth = mkOption {
      default = 0;
      description = "Maximum width of text that is being inserted";
      type = types.int;
    };

    exitWith = mkOption {
      default = "jk";
      description = "Keys to exit to normal mode";
      type = types.int;
    };
  ...
  config = (
    ...
    vim.configRC = ''
      ...
      set textwidth=${toString cfg.textWidth}
      set hidden
